...
class Settings(BaseSettings):
    ...
    # No default: used to build the OAuth callback redirect back to the SPA.
    # A defaulted "localhost:5173" would let a prod deploy that forgot to set
    # it silently redirect users to a dev URL (rule 12).
