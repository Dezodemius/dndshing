...
export const SHEET_LAYOUT_SPEC: readonly SheetLayoutSpecEntry[] = [
  ...
  { id: 'portrait', labelKey: 'pages.printableSheet.blocks.portrait', page: 2, column: 'left', row: 1, status: 'partial', reason: 'DND-106 owns portrait upload; a portrait URL is rendered when the API supplies one.' },
  { id: 'backstory', labelKey: 'pages.printableSheet.blocks.backstory', page: 2, column: 'left', row: 2, status: 'implemented' },
  { id: 'goals', labelKey: 'pages.printableSheet.blocks.goals', page: 2, column: 'left', row: 3, status: 'implemented' },
  ...
  { id: 'notes', labelKey: 'pages.printableSheet.blocks.notes', page: 3, column: 'left', row: 1, status: 'implemented' },
  { id: 'appearance', labelKey: 'pages.printableSheet.blocks.notes', page: 3, column: 'right', row: 1, status: 'implemented' },
